...
public class FacturaService {
    ...
    public Factura generate(Factura factura) {
        final String URL = "http://gavasoftcomprassapp.railway.internal:8084/v1/facturas/generar-nueva";
    ...
    public List<Factura> listPagadasByClienteNumDocumento(String clienteNumDocumento) {
        final String URL = "http://gavasoftcomprassapp.railway.internal:8084/v1/facturas/clientes/{clienteNumDocumento}/pagadas";
