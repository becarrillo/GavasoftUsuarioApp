...
public class IngresoService {
    ...
    public List<Ingreso> searchByClienteNumDocumento(String clienteNumDocumento) {
        return restTemplate.getForObject("http://gavasoftcomprassapp.railway.internal:8084/v1/ingresos/clientes/{clienteNumDocumento}", List.class, clienteNumDocumento);
    }
}
